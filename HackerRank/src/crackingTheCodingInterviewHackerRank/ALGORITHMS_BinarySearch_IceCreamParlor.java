...
during each visit. For each trip to the parlor, print the ID numbers for the two types of ice cream
...
public class ALGORITHMS_BinarySearch_IceCreamParlor {
...
The first time, they pool together m=4 dollars. There are five flavors available that day and flavors 1 and 4 have
a total cost of 1+3=4. Thus, we print 1 4 on a new line.
The second time, they pool together m=4 dollars. There are four flavors available that day and flavors 1 and 2 have
a total cost of 2+2=4. Thus, we print 1 2 on a new line*/