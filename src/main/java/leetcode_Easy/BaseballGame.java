...
/*682 You're now a baseball game point recorder. Given a list of strings, each
string can be one of the 4 following types:
1) Integer (one round's score): Directly represents the number of points you get
in this round.
...
and the round after. You need to return the sum of the points you could get in
all the rounds *!*Let's maintain the value of each valid round on a stack as we
process the data. A stack is ideal since we only deal with operations involving
