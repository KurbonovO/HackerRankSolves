...
/*682 You're now a baseball game point recorder. Given a list of strings, each string can be one of
the 4 following types:
...
3) "D" (one round's score): Represents that the points you get in this round are the doubled data of the
