...
public class FindSmallestLetterGreaterThanTargetLeetCode {
	...
	public char nextGreatestLetter(char[] a, char x) {
		...
		// Terminal condition is 'lo < hi', to avoid infinite loop when target is
		...
		// Because lo can end up pointing to index 'n', in which case we return the
		// first element
		return a[lo % n];
	}
