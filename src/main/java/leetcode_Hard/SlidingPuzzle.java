...
/*773 On a 2x3 board, there are 5 tiles represented by the integers 1 through 5
...
/*Input: board = [[1,2,3],[4,0,5]] Output: 1 Swap the 0 and the 5 in one move.

Input: board = [[1,2,3],[5,4,0]] Output: -1 No number of moves will make the
board solved.
  
Input: board = [[4,1,2],[5,0,3]] Output: 5 5 is the smallest number of moves
that solves the board.
  
An example path: After move 0: [[4,1,2],[5,0,3]] After move 1:
