...
public class IteratorForCombinationD {
	...
	String result, str; // str - same as characters. result -- the result string representing a
						// combination
	int combLength; // same as combinationLength

	public IteratorForCombinationD(String characters, int combinationLength) {
	...
	public String next() {
		...
		// keep on removing the last character from the stack/result till the position
		// where idx can be moved ahead
