...
/*299 You are playing the following Bulls and Cows game with your friend: You
...
eventually derive the secret number. Write a function to return a hint
according to the secret number and friend's guess, use A to indicate the bulls
