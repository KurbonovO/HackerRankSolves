...
/*576 here is an m by n grid with a ball. Given the start coordinate (i,j) of the ball,
...
paths to move the ball out of grid boundary. The answer may be very large, return it
after mod 10^9 + 7.
