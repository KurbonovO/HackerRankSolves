...
/*692 Given a non-empty list of words, return the k most frequent elements.Your
answer should be sorted by frequency from highest to lowest. If two words have
the same frequency, then the word with the lower alphabetical order comes first
input: ["i", "love", "leetcode", "i", "love", "coding"], k = 2
Output: ["i", "love"]
"i" and "love" are the two most frequent words.Note that "i" comes before 
...
public class TopKFrequentWords {
	public List<String> topKFrequent(String[] words, int k) {
		...
		PriorityQueue<Map.Entry<String, Integer>> pq = new PriorityQueue<>((a,
				b) -> a.getValue() == b.getValue() ? b.getKey().compareTo
